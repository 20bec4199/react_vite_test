        ...
        <section id="projects" className="min-h-screen flex items-center justify-center py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                    ...
                    <p className="text-gray-400 mb-4">Built a responsive e-commerce platform using the MERN stack with secure authentication, product management, and integrated payment processing.
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                    <h3 className="text-xl font-bold mb-2"> Live Chat App</h3>
                    <p className="text-gray-400 mb-4">Built a responsive e-commerce platform using the MERN stack with secure authentication, product management, and integrated payment processing.
